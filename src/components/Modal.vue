...
const modalVariants = cva(
  'ui-surface ui-border relative w-full max-h-[100vh] overflow-y-auto rounded-xl shadow-lg duration-200 p-0 overflow-hidden',
  {
    variants: {
      size: {
        sm: 'max-w-sm',
...
<template>
  <Teleport to="body">
    ...
    >
      <div
        v-if="modelValue"
        class="fixed ui-bg inset-0 z-9999 backdrop-blur-2xl flex items-center justify-center"
