        ...
        >
          ...
          <template #actions="{ item }">
            <div class="flex items-center gap-2 justify-center">
              <button
                @click="viewUser(item)"
                class="p-1 text-slate-400 hover:text-blue-600 rounded transition-colors"
                title="View details"
              >
                <EyeIcon />
              </button>
...
import DataTableFilters from '../src/components/DataTableFilters.vue'
import DataTableToolBar from '../src/components/DataTableToolBar.vue'

// Fixed Icon Components - using defineComponent with render functions
...
// Updated bulk actions with proper structure using our icon components
const bulkActions = [
  {
    key: 'activate',
    ...
    icon: defineComponent({
      render: () => h('svg', {
        ...
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728L5.636 5.636m12.728 12.728L12 12m6.364 6.364L12 12m-6.364-6.364L12 12'
        })
      ])
    })
  },
...
/* Ensure icons are properly colored and sized */
svg {
  color: inherit;
}

.text-slate-400:hover svg,
.hover\:text-blue-600:hover svg {
  color: inherit;
}

.hover\:text-red-600:hover svg {
  color: inherit;
}
</style>